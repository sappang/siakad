    ...
    return (
        <>
            ...
            <div>
                            ...
                            >
                                <Dialog.Panel className="relative mr-16 flex w-full max-w-xs flex-1">
                                    <Transition.Child
                                        ...
                                        leaveTo="opacity-0"
                                    >
                                        <div className="absolute left-full top-10 flex w-16 justify-center pt-5">
                                            <button
                                                type="button"
                ...
                <div className="sticky top-0 z-40 flex items-center gap-x-6 bg-white p-4 shadow-sm lg:hidden">
                    <button
                        type="button"
